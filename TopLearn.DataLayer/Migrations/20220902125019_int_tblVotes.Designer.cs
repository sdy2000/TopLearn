...
namespace TopLearn.DataLayer.Migrations
{
    ...
    [Migration("20220902125019_int_tblVotes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.Course", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.CourseComment", b =>
                {
                    b.Property<int>("CommetnId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CommetnId"), 1L, 1);
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.CourseEpisode", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.CourseLevel", b =>
                {
                    b.Property<int>("LevelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.CourseStatus", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.CourseVote", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.UserCourse", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Order.Descount", b =>
                {
                    ...
                    b.Property<string>("DescountCode")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<int>("DescountPercent")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.Course", b =>
                {
                    b.HasOne("TopLearn.DataLayer.Entities.Cource.CourseGroup", "CourseGroup")
                        .WithMany("Courses")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TopLearn.DataLayer.Entities.Cource.CourseLevel", "CourseLevel")
                        .WithMany("Courses")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TopLearn.DataLayer.Entities.Cource.CourseStatus", "CourseStatus")
                        .WithMany("Courses")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TopLearn.DataLayer.Entities.Cource.CourseGroup", "Group")
                        .WithMany("SubGroup")
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.CourseComment", b =>
                {
                    b.HasOne("TopLearn.DataLayer.Entities.Cource.Course", "Course")
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Cource.CourseVote", b =>
                {
                    b.HasOne("TopLearn.DataLayer.Entities.Cource.Course", "Cource")
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.User.UserDiscountCode", b =>
                {
                    b.HasOne("TopLearn.DataLayer.Entities.Order.Descount", "Descount")
